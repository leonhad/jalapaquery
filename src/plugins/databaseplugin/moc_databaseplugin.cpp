...
const QMetaObject DatabasePlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DatabasePlugin.data,
      qt_meta_data_DatabasePlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DatabasePlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DatabasePlugin.stringdata0))
        return static_cast<void*>(const_cast< DatabasePlugin*>(this));
    if (!strcmp(_clname, "ModelInterface"))
        return static_cast< ModelInterface*>(const_cast< DatabasePlugin*>(this));
