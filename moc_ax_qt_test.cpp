/****************************************************************************
** Meta object code from reading C++ file 'ax_qt_test.h'
**
...
#error "The header file 'ax_qt_test.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 11, 7) // "receive"

    },
    "Test\0send\0\0receive"
};
...
void Test::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Test::send)) {
                *result = 0;
            }
        }
    }
